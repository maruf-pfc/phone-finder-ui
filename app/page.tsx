  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Choose your dream phone</h1>
            <p className="text-xl text-muted-foreground">
              Compare features, read reviews, and make informed decisions with our comprehensive phone finder platform.
            </p>
      ...
      <section className="py-16">
        <h2 className="text-3xl font-bold text-center mb-12">Why Choose Phone Finder</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="text-muted-foreground">Read authentic reviews from verified buyers and tech enthusiasts.</p>
          </div>
          <div className="bg-card rounded-lg p-6 shadow-sm">
            <div className="bg-primary/10 p-3 rounded-full w-fit mb-4">
            ...
            <p className="text-muted-foreground">Purchase with confidence through our secure e-commerce platform.</p>
          </div>
        </div>
      </section>
