      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl hidden sm:inline-block">Phone Finder</span>
          </Link>
        </div>
          ...
          <NavigationMenuList>
            <NavigationMenuItem>
              <Link href="/phones" legacyBehavior passHref>
                <NavigationMenuLink className={navigationMenuTriggerStyle()}>Phones</NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
            <NavigationMenuItem>
                ...
                <ul className="grid gap-3 p-6 w-[400px] grid-cols-2">
                  <li>
                    <NavigationMenuLink asChild>
                      ...
                      >
                        <div className="text-sm font-medium leading-none">Discussions</div>
